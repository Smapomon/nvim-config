...
local on_attach = function(client, bufnr)
  ...
  editor.keymap.set('n', 'gr', editor.lsp.buf.rename, bufopts)
...
local servers = { 'solargraph', 'templ', 'html', 'bashls', 'kotlin_language_server', 'templ', 'ts_ls', 'rust_analyzer', 'lua_ls', 'terraformls', 'clangd', 'yamlls', 'slint_lsp' }
